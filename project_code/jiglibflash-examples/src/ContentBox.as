package 
{
	...
	public class ContentBox extends Sprite 
	{
		...
		private var boxSize                 : Vector3D = new Vector3D(250,600,250);
		...
		{	
			...
			if (gridSystem) physics.engine.setCollisionSystem(true, -500, -500, 0, 30, 30, 30, 200, 200, 200);
			...
			material.alpha = .01;
			var wall01:RigidBody = physics.createCube(material, 50, boxSize.y, boxSize.z+100);
			var wall02:RigidBody = physics.createCube(material, 50, boxSize.y, boxSize.z+100);
			var wall03:RigidBody = physics.createCube(material, boxSize.x+150, boxSize.y, 50);
			var wall04:RigidBody = physics.createCube(material, boxSize.x+150, boxSize.y, 50);
			wall01.x = - 50-boxSize.x/2; wall02.x = 50+boxSize.x/2;
			wall03.z = - 50-boxSize.z/2; wall04.z = 50+boxSize.z/2;
			wall01.y = wall02.y = wall03.y = wall04.y = boxSize.y/2;
			wall01.movable = wall02.movable = wall03.movable = wall04.movable = false;
			wall01.friction = wall02.friction = wall03.friction = wall04.friction = 0.1;
			wall01.restitution = wall02.restitution = wall03.restitution = wall04.restitution = 0.1;
			
			Away3D4Mesh(wall01.skin).mesh.castsShadows=false;
			Away3D4Mesh(wall02.skin).mesh.castsShadows=false;
			Away3D4Mesh(wall03.skin).mesh.castsShadows=false;
			Away3D4Mesh(wall04.skin).mesh.castsShadows=false;
